...
require_once MODX_CORE_PATH . '/components/billing/processors/web/orders/submit.class.php';
...
class modBasketWebOrdersSubmitProcessor extends modWebOrdersSubmitProcessor{
    ...
    */
    protected $allowGetUserByEmail = false;
    ...
    */
    ...
    protected function getContractorGroups(){
        ...
        if($modUserGroup = $this->modx->getObject('modUserGroup', $this->modx->getOption('shop.customers_group', null, 0))){
    ...
    */
    ...
    public function cleanup() {
        ...
        return $this->success('Заказ успешно принят',$this->object->toArray());
    }    
    
}

return 'modBasketWebOrdersSubmitProcessor';
